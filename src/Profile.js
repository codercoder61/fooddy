...
setNameSurname(`${result.userData.name} ${result.userData.surname}`);
    ...
    const fetchData2= useCallback(async()=>{
      try {
        await fetch("https://pneuexpress.online/foody/getCategories.php", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    useEffect(()=>{
        ...
        fetchMeals()
        fetchData()
    },[fetchData,fetchMeals,fetchData2])
        ...
        <div style={{padding:'40px'}}>
            ...
            <div id='op'>
                <div id='po'>
                    ...
                    {!previewUrl2 && <img onClick={handleImageClick2} style={{padding:'2px', cursor: 'pointer',border:'2px dashed #000', borderRadius: '10px'}} width='120' src={src2===null?'':src2} alt="Click to upload"/>}
                    <input
                        type="file"
                        ref={fileInputRef}

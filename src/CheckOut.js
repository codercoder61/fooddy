...
function CheckOut() {
   ...
   const handleSubmit = async (e)=>{
        ...
        if(surname!=="" && email!=="" && name!=="" && phone!=="" && addressInput!=="" ){

  
         try {
        const response = await fetch("https://pneuexpress.online/foody/addOrder.php", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        <div id='lama'>
              ...
              <div className='food'>
                <form className='form2' onSubmit={handleSubmit}>
                    ...
                    <input style={{border:error5?"1px dashed red":""}} id="surname" type="text" value={surname} onChange={handleSurNameChange} />

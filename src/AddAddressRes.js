...
function AddAddressRes() {
      ...
      <main id='mainn'>
        <div>
            ...
            <p style={{fontSize: '1.2em',fontWeight: 'unset',marginBottom:'50px'}}>One last step left</p>
                ...
                <input value={restaurantName} style={{border:(restaurantName)?"1px solid #fb9300":"1px solid red"}} onChange={handleRestaurantNameChange} placeholder='Type here...' type="text" /><br/><br/>
  ...
  onClick={async () => {
    ...
    try {
      const response = await fetch("https://pneuexpress.online/foody/updateRestaurantOwnerAddress.php", {
        method: "POST",
        headers: {

...
function isValidPhoneNumber(phone) {
  ...
  return `${day} ${month} ${hours}:${minutes}`;
    ...
    const createTicket = async ()=>{
      const payload = {
        ...
        if(!errorTicket){
        try {
          const res = await fetch("https://pneuexpress.online/foody/createTicketAdmin.php", {
            method: "POST",
            headers: {
    ...
    const addMessageToTicket = async (e)=>{
      ...
      const payload = {
        ...
        if(!errorTicket){
        try {
          await fetch("https://pneuexpress.online/foody/addMessageToTicketAdmin.php", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
    ...
    const getTicketMessages = async (ticketId)=>{
      const payload = {
        ...
        try {
          const res = await fetch("https://pneuexpress.online/foody/getTicketMessages2.php", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
    ...
    const closeTicket = async (ticketId)=>{
      const payload = {
        ...
        try {
          const res = await fetch("https://pneuexpress.online/foody/closeTicket.php", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
  ...
  try {
    const res = await fetch("https://pneuexpress.online/foody/updateAdminInfo.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const fetchTickets = async () => {
  try {
    const response = await fetch("https://pneuexpress.online/foody/getAllTickets.php", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
...
const fetchReportedComments = async () => {
  try {
    const response = await fetch("https://pneuexpress.online/foody/getReportedComments.php", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
...
const fetchAllOrders = async () => {
  try {
    const response = await fetch("https://pneuexpress.online/foody/getAllOrders.php", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
...
const fetchAllUsers = async () => {
  try {
    const response = await fetch("https://pneuexpress.online/foody/getUsers.php", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
...
const getAdminInfo = async () => {
  try {
    const response = await fetch("https://pneuexpress.online/foody/getAdminInfo.php", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
    ...
    try {
      const res = await fetch("https://pneuexpress.online/foody/updateAppCommissionInfo.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
 ...
 const deleteComment = async(id)=>{
  try {
      const res = await fetch("https://pneuexpress.online/foody/deleteComment.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
   ...
   const saveChanges2 = async ()=>{
    ...
    try {
      const res = await fetch("https://pneuexpress.online/foody/updateCourrierCommissionInfo.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    try {
      const res = await fetch("https://pneuexpress.online/foody/updateCompanyInfo.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
try {
      const res = await fetch("https://pneuexpress.online/foody/blockCustomer.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
try {
      const res = await fetch("https://pneuexpress.online/foody/blockResto.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
try {
      const res = await fetch("https://pneuexpress.online/foody/blockCourrier.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
try {
      const res = await fetch("https://pneuexpress.online/foody/unBlockCustomer.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
try {
      const res = await fetch("https://pneuexpress.online/foody/unBlockCourrier.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
try {
      await fetch("https://pneuexpress.online/foody/confirmCourrier.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
try {
      await fetch("https://pneuexpress.online/foody/unBlockResto.php",  {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const getStats= async()=>{
      try {
        const response = await fetch("https://pneuexpress.online/foody/statsAdmin.php", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          }
    ...
    useEffect(()=>{
      ...
      const barreaux=useCallback((data)=>{
            let labels = [];
            let num_orders = [];
  ...
  num_orders.push(element[1]);
          ...
          chartRef.current = new Chart(ctx, {
            ...
            useEffect(() => {
              ...
              }, [barreaux,ordersPerMonth,analytics]); // ← re-run when `analytics` changes
const barreaux2 = useCallback((data) => {
    let labels = [];
    let values = [];
    ...
    labels = sortedData.map(d => `${monthNames[d.month - 1]} ${d.year}`);
...
}, [barreaux2,userpermonth, analytics]);
  ...
  return (
    <div>
      <i onClick={handleClick} id='fd' className="fa-solid fa-bars"></i>
...
{success6 && <p ref={message6} className='message' style={{textAlign:'center',zIndex:'5000',position:'fixed',top:'0',width:'100%',backgroundColor:'#bfe9d3',border:'1px solid #008d00'}}>A new ticket successfully created!</p>}

{successDelete && <p ref={messageDelete} className='message' style={{textAlign:'center',zIndex:'5000',position:'fixed',top:'0',width:'100%',backgroundColor:'#bfe9d3',border:'1px solid #008d00'}}>Comment successfully deleted!</p>}
{success7 && <p ref={message7} className='message' style={{textAlign:'center',zIndex:'5000',position:'fixed',top:'0',width:'100%',backgroundColor:'#bfe9d3',border:'1px solid #008d00'}}>Success!</p>}
      {success && <p ref={message} className='message' style={{textAlign:'center',zIndex:'5000',position:'fixed',top:'0',width:'100%',backgroundColor:'#bfe9d3',border:'1px solid #008d00'}}>Changes are successfully saved!</p>}
      {fail && <p ref={message2} className='message' style={{textAlign:'center',zIndex:'5000',position:'fixed',top:'0',width:'100%',backgroundColor:'rgba(255,0,0,0.5)',border:'1px solid red'}}>Changes were not successfully saved!</p>}
                ...
                <tbody>
                  ...
                  {filteredOrders && filteredOrders.map((elm,index) => (
                    <tr key={elm.orders.order_id} style={{ backgroundColor: '#fff' }}>
                      <td style={{display:'flex',alignItems:'center',padding: '10px 10px' }}>{elm.orders.order_id}</td>
            ...
            {users &&  <div id='pod'>
               ...
               <table>
                ...
                <tbody>
                  ...
                  {elm.driverLicence ? (
                    <a
                      href={`https://pneuexpress.online/foody/${elm.driverLicence}`}
                      target="_blank"
              ...
              <tr key={elm.id} style={{ backgroundColor: '#fff' }}>
                ...
                <td className="hid" style={{ padding: '10px' }}>
                  {elm.photo && elm.photo!=="N/A" ? (
                    <img
                      src={`https://pneuexpress.online/foody/${elm.photo}`}
                      alt="Courier"
                      style={{
                        width: '60px',
                        height: '60px',
                      ...
                      onClick={() =>
                        window.open(`https://pneuexpress.online/foody/${elm.photo}`, '_blank')
                      }
                    />
                  ) : (
                    "-"
        ...
        {credentials && <div>
            ...
            <div id='userr'>
                <div id="hh5">
                    ...
                    <input value={emailAdmin} onChange={handleEmailAdminChange} placeholder='Type here...' type="email"/>
                ...
                <div id='top'>
                  <div className='sau'>
                    ...
                    {topRestaurants && topRestaurants.map((elm,index)=>(
                      ...
                      <div style={{display:'flex',alignItems:'center'}}><img alt="eaze" height='40' width='40' style={{borderRadius:'50%',objectFit:'cover',marginRight:'5px'}} src={elm.restoInfo.logo!=null?`https://pneuexpress.online/foody/${elm.restoInfo.logo}`:"https://21985162c3f6de69b3a2fa38c4458a89.cdn.bubble.io/cdn-cgi/image/w=48,h=48,f=auto,dpr=1,fit=contain/f1643645120337x435152378012765760/chefauchef-01%2B%281%29.png"}/><span>{elm.restoInfo.restaurantName}</span></div>
                  ...
                  <div className='sau'>
                    ...
                    {mostpopularRestaurants && mostpopularRestaurants.map((elm,index)=>(
                      <div key={index} style={{display:'flex',marginTop:'10px',justifyContent:'space-between',alignItems:'center'}}>
                      <div style={{display:'flex',alignItems:'center'}}><img alt="eaz" height='40' width='40' style={{borderRadius:'50%',objectFit:'cover',marginRight:'5px'}} src={elm.restoInfo.logo!=null?`https://pneuexpress.online/foody/${elm.restoInfo.logo}`:"https://21985162c3f6de69b3a2fa38c4458a89.cdn.bubble.io/cdn-cgi/image/w=48,h=48,f=auto,dpr=1,fit=contain/f1643645120337x435152378012765760/chefauchef-01%2B%281%29.png"}/><span>{elm.restoInfo.restaurantName}</span></div>
                  ...
                  <div className='sau'>
                     ...
                     {mostUsers && mostUsers.map((elm,index)=>(
                      <div key={index} style={{display:'flex',marginTop:'10px',justifyContent:'space-between',alignItems:'center'}}>
                      <div style={{display:'flex',alignItems:'center'}}><img alt="aeaz" height='40' width='40' style={{borderRadius:'50%',objectFit:'cover',marginRight:'5px'}} src={elm.userInfo?.photo!=null?`https://pneuexpress.online/foody/${elm.userInfo?.photo}`:"https://21985162c3f6de69b3a2fa38c4458a89.cdn.bubble.io/cdn-cgi/image/w=48,h=48,f=auto,dpr=1,fit=contain/f1643645120337x435152378012765760/chefauchef-01%2B%281%29.png"}/><span>
  {elm.userInfo?.name?.trim()} {" "+elm.userInfo?.surname?.trim()}
</span>
</div>

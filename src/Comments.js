...
const updateQuantity = (index, quantity) => {
  ...
  setNumberOfItems(number);
    ...
    const addFavorite = async ()=>{
      try {
        await fetch("https://pneuexpress.online/foody/addFavorite.php", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  setNumberOfItems(number)
    ...
    useEffect(() => {
        ...
        const report = async (id_comment,idResto,idComment,id_order)=>{
            try {
                    const response = await fetch("https://pneuexpress.online/foody/report.php", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
...
style={{ border: 'none', outline: 'none', height: '20px', width: '60px', }}
   ...
   <div id='fall'>
      ...
      <p>anything to your cart yet</p>
        ...
        <div id='pop'>
            <img alt="aeaz" style={{marginRight:'20px',borderRadius:'50%',objectFit:'cover'}} width='150' height='150' src={res.logo!==null?`https://pneuexpress.online/foody/${res.logo}`:'https://21985162c3f6de69b3a2fa38c4458a89.cdn.bubble.io/cdn-cgi/image/w=64,h=,f=auto,dpr=1,fit=contain/f1643645120337x435152378012765760/chefauchef-01%2B%281%29.png'}/>
           ...
           <h1 id='fo'>Comments From Customers ({numComments})</h1>
            <div style={{marginTop:'20px'}}>
                {commentsOnMeals && commentsOnMeals.length>0 && commentsOnMeals.map((elm,index)=>(
                    ...
                    <div className='coo'>
                        <div style={{display:'flex',alignItems:'center'}}>
                            <img alt="eazeza" width='60' style={{borderRadius:'50%',objectFit:'cover'}} height='60' src={elm.user.photo!=null?`https://pneuexpress.online/foody/${elm.user.photo}`:'https://21985162c3f6de69b3a2fa38c4458a89.cdn.bubble.io/cdn-cgi/image/w=96,h=96,f=auto,dpr=1,fit=contain/f1643645120337x435152378012765760/chefauchef-01%2B%281%29.png'}/>
                    ...
                    {elm.commentcontent.length===2 && <div className='pala'>
                        <div style={{width:'100%',display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                             <div style={{display:'flex',alignItems:'center'}}><img alt="eazeaz" width='60' style={{borderRadius:'50%',objectFit:'cover'}} height='60' src={res.logo!=null?`https://pneuexpress.online/foody/${res.logo}`:'https://21985162c3f6de69b3a2fa38c4458a89.cdn.bubble.io/cdn-cgi/image/w=96,h=96,f=auto,dpr=1,fit=contain/f1643645120337x435152378012765760/chefauchef-01%2B%281%29.png'}/>
                                    <div style={{marginLeft:'10px'}}>

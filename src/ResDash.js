...
function ResDash() {
    ...
    const getOrders = async ()=>{
      const payload = {
        ...
        if(!errorTicket){
        try {
          const res = await fetch("https://pneuexpress.online/foody/getOrdersRes.php", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
    ...
    const getTicketMessages = async (ticketId)=>{
      const payload = {
        ...
        try {
          const res = await fetch("https://pneuexpress.online/foody/getTicketMessages.php", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
    ...
    const showUpdateMealPopUp = (index)=>{
      ...
      setSrc2(`https://pneuexpress.online/foody/${meals2[index].photo}`)
  ...
  try {
    const res = await fetch("https://pneuexpress.online/foody/updateResInfo3.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const chartRef2 = useRef(null);
    ...
    const fetchData= useCallback(async()=>{
      try {
        const response = await fetch("https://pneuexpress.online/foody/getres.php", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        if(result.userData.logo!==null)
          setSrc(`https://pneuexpress.online/foody/${result.userData.logo}`)
      } catch (error) {
    ...
    const deleteMeal= async (id)=>{
      try {
        const response = await fetch("https://pneuexpress.online/foody/deleteMeal.php", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  try {
    const response = await fetch("https://pneuexpress.online/foody/getMeals.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const fetchComments = useCallback(async () => {
  try {
    const response = await fetch("https://pneuexpress.online/foody/getComments.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  useEffect(()=>{
    ...
    fetchTickets()
    fetchComments()
  },[fetchData,fetchData2,fetchMeals,fetchTickets,fetchComments,uniqId])
  useEffect(() => {
...
const donut= useCallback(async(data)=>{
      let labels = [];
  let num_orders = [];
 ...
 useEffect(() => {
  ...
  }, [donut,bestsellermeals,analytics]); // ← re-run when `analytics` changes
  ...
  const handleImageClick = () => {
    ...
    try {
      const res = await fetch("https://pneuexpress.online/foody/updateResInfo.php", {
        method: "POST",
        body: formData,
      });
  ...
  try {
    const res = await fetch("https://pneuexpress.online/foody/updateResInfo2.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
if(!error1 && !error2 && !error3 && !error4 && !error5){
    try {
      const res = await fetch("https://pneuexpress.online/foody/updateMeal.php", {
        method: "POST",
        body: formData,
      });
...
if(!error1 && !error2 && !error3 && !error4 && !error5){
    try {
      const res = await fetch("https://pneuexpress.online/foody/addMeal.php", {
        method: "POST",
        body: formData,
      });
...
const payload = {
  ...
  try {
    const res = await fetch("https://pneuexpress.online/foody/updateOrderStatus.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const createReply = async (id_customer) =>{
      ...
      try {
        const response = await fetch("https://pneuexpress.online/foody/reply.php", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    const getStats= useCallback(async()=>{
      try {
        const response = await fetch("https://pneuexpress.online/foody/statsResto.php", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    useEffect(()=>{
      ...
      const barreaux= useCallback(async(data)=>{
         let labels = [];
      let num_orders = [];
    if (!analytics || !canvasRef.current) return;
...
<div style={{wordBreak:'break-word',display:'flex',marginTop:'10px',fontSize:'0.8em'}}>
         <img width='70' height='70' style={{borderRadius:'50%',objectFit:'cover',margin:'0px 20px 20px 0'}} src={photo?`https://pneuexpress.online/foody/${photo}`:'https://21985162c3f6de69b3a2fa38c4458a89.cdn.bubble.io/cdn-cgi/image/w=64,h=,f=auto,dpr=1,fit=contain/f1643645120337x435152378012765760/chefauchef-01%2B%281%29.png'} alt={`${photo}`} />
            <div>
                ...
                <tbody>
                  ...
                  {meals2 && meals2.map((elm,index) => (
                    <tr key={elm.id} style={{ backgroundColor: '#fff' }}>
                      <td style={{display:'flex',alignItems:'center',padding: '40px 20px' }}><img width='100' height='100' style={{borderRadius:'50%',objectFit:'cover',marginRight:'10px'}} src={`https://pneuexpress.online/foody/${elm.photo}`} alt={`meal${index+1}`}/> {elm.name}</td>
